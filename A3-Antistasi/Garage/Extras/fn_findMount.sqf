...
private _failed = { 
    ["STR_HR_GRG_Feedback_requestMount_Denied"] remoteExec ["HR_GRG_fnc_Hint", _owner]; 
    [true] remoteExecCall ["HR_GRG_fnc_toggleConfirmBttn", _owner]; 
    [true] remoteExecCall ["HR_GRG_fnc_toggleSellBttn", _owner];
    false 
};
