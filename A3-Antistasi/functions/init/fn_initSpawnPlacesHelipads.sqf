...
//Searches the buildings on the main marker for helipads
{
    ...
    if((_building isKindOf "Helipad_Base_F" || {_building isKindOf "Land_BludpadCircle" || {_building isKindOf "Land_vn_b_helipad_01"}}) && {_pos inArea _marker}) then
    {
...
//Searches the helipad markers of the marker for helipads
{
    ...
    private _subBuildings = nearestObjects [getMarkerPos _subMarker, ["Helipad_Base_F","Land_BludpadCircle","Land_vn_b_helipad_01"], _distance, true];
    {
