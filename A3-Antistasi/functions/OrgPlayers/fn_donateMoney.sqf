...
if (_resourcesPlayer < 100) exitWith {["Donate Money", format ["You have less than 100%1 to donate.", currencySymbol]] call A3A_fnc_customHint;};
...
if (count _this == 0) exitWith {
	...
	["Donate Money", format ["You have donated 100%1 to the cause. This will raise your status among our forces.", currencySymbol]] call A3A_fnc_customHint;
};
...
["Donate Money", format ["You have donated 100 %2 to %1.", name _target, currencySymbol]] call A3A_fnc_customHint;
