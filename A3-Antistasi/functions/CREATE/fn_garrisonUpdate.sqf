...
[3, format ["Garrison before update: %1", str _previousGarrison], "garrisonUpdate.sqf"] call A3A_fnc_log;
...
[3, format ["Garrison after update: %1", str _garrison], "garrisonUpdate.sqf"] call A3A_fnc_log;
