...
private _filename = "SCRT_fnc_build_updateConstruction";
...
[2, format ["Updated already created %1 object on %2 position.", (typeOf _building), (position _building)], _filename, true] call A3A_fnc_log;